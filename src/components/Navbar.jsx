      ...
      <div className="z-10 w-full block sm:flex sm:justify-between sm:items-center py-6">
        <div>
          <Link to="/" className="flex items-center">
            <img
              src="https://png.pngtree.com/png-vector/20230420/ourmid/pngtree-green-leaf-icon-design-template-vector-image_6710581.png"
              className="w-20"
            />
            <p className="text-4xl font-bold pb-2 text-green-800">HealthFull</p>
          </Link>
        </div>
        <div>
          <Link
